...
class mailing {
  ...
  public static void main(String argv[]) throws Exception {
    String user = "s2010876140@ru.ac.bd";
    String pass = "MjUvMDMvMjAwMXJ1LmFjLmJkCg";
    ...
    send("MAIL FROM:<s2010876140@ru.ac.bd>\r\n");
              System.out.println("SERVER: "+ br.readLine());


    send("RCPT TO:<mominur.sumon1@gmail.com>\r\n");
              System.out.println("SERVER: "+ br.readLine());
    ...
    send("FROM: s2010876140@ru.ac.bd\r\n");
    send("TO: mominur.sumon1@gmail.com\r\n");
